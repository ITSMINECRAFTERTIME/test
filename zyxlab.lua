...
function activatePCCrawlMobile()
    ...
    local ok, err = xpcall(function()
        ...
        local function removeDefaultCrawlButtons()
            local touchGui = playerGui:FindFirstChild("TouchGui")
            local touchFrame = touchGui and touchGui:FindFirstChild("TouchControlFrame")
            if not touchFrame then return end

            for _, child in pairs(touchFrame:GetChildren()) do
                if child.Name == "ContextActionButton" and not child:GetAttribute("ZyxPCCrawlButton") then
                    local looksLikeCrawl = false
                    ...
                    if looksLikeCrawl then child:Destroy() end
                end
            end
        end
        ...
        env.__ZyxPCCrawlMobileThread = task.spawn(function()
            while env.__ZyxPCCrawlMobileActivated do
                ...
                pcall(removeDefaultCrawlButtons)
            end
        end)
    end, function(e)
        return tostring(e)
