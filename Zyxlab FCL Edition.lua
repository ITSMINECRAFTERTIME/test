    ...
    showErrorOnScreen = function(msg)
        ...
        pcall(function()
            ...
            if not _errorGui or not _errorGui.Parent then
                ...
                _errorGui.Name = "ZyxLabFCL_ErrorDisplay"
...
-- =============================================
-- ✨ FCL STARTUP LOADER (SLEEK / NON-BLOCKING)
-- =============================================
do
    local ok, err = xpcall(function()
        local DEBUG = false
        local function log(...)
            if DEBUG then print("[ZyxLab FCL Loader]", ...) end
        end
        ...
        if not guiParent then
            warn("[ZyxLab FCL Loader] Could not find a GUI parent")
            return
        end

        pcall(function()
            local old = guiParent:FindFirstChild("ZyxLabFCL_LoadingScreen")
            if old then old:Destroy() end
        end)

        local accent = Color3.fromRGB(118, 86, 255)
        local accent2 = Color3.fromRGB(45, 210, 255)
        local bgDark = Color3.fromRGB(8, 8, 14)
        local cardDark = Color3.fromRGB(15, 14, 24)
        ...
        gui.Name = "ZyxLabFCL_LoadingScreen"
        ...
        overlay.BackgroundColor3 = bgDark
        ...
        veil.Name = "VeilGradient"
        veil.Size = UDim2.new(1, 0, 1, 0)
        veil.BackgroundTransparency = 1
        veil.BorderSizePixel = 0
        veil.ZIndex = 1
        veil.Parent = overlay
        local veilGrad = Instance.new("UIGradient")
        veilGrad.Color = ColorSequence.new({
        ...
        veilGrad.Rotation = 25
        veilGrad.Parent = veil

        local glow = Instance.new("ImageLabel")
        glow.Name = "SoftBackGlow"
        glow.AnchorPoint = Vector2.new(0.5, 0.5)
        glow.Position = UDim2.new(0.5, 0, 0.5, 0)
        glow.Size = UDim2.new(0, 520, 0, 260)
        glow.BackgroundTransparency = 1
        glow.BorderSizePixel = 0
        glow.Image = "rbxassetid://8992230677"
        glow.ImageColor3 = accent
        glow.ImageTransparency = 0.42
        ...
        card.Size = UDim2.new(0, 430, 0, 168)
        card.BackgroundColor3 = cardDark
        ...
        cardGrad.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(21, 19, 33)),
            ColorSequenceKeypoint.new(0.58, Color3.fromRGB(13, 12, 22)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 11, 19)),
        })
        ...
        rail.Name = "TopRail"
        rail.Position = UDim2.new(0, 18, 0, 15)
        ...
        logoWrap.Position = UDim2.new(0, 22, 0, 38)
        logoWrap.Size = UDim2.new(0, 58, 0, 58)
        logoWrap.BackgroundColor3 = Color3.fromRGB(20, 19, 31)
        ...
        ring.ZIndex = 6
        ring.Parent = logoWrap
        local ringStroke = Instance.new("UIStroke")
        ringStroke.Color = accent2
        ...
        logoText.ZIndex = 7
        logoText.Parent = logoWrap

        local title = Instance.new("TextLabel")
        title.Name = "Title"
        title.Position = UDim2.new(0, 96, 0, 37)
        title.Size = UDim2.new(1, -126, 0, 28)
        title.BackgroundTransparency = 1
        title.Text = "ZyxLab FCL Edition"
        ...
        subtitle.Position = UDim2.new(0, 98, 0, 66)
        subtitle.Size = UDim2.new(1, -128, 0, 17)
        subtitle.BackgroundTransparency = 1
        subtitle.Text = "Flee the Facility • clean utility build"
        subtitle.TextColor3 = Color3.fromRGB(148, 143, 176)
        ...
        status.Name = "Status"
        status.Position = UDim2.new(0, 22, 1, -52)
        status.Size = UDim2.new(1, -44, 0, 19)
        ...
        percent.Position = UDim2.new(1, -22, 1, -52)
        percent.Size = UDim2.new(0, 72, 0, 19)
        percent.BackgroundTransparency = 1
        percent.Text = "0%"
        percent.TextColor3 = Color3.fromRGB(154, 149, 181)
        percent.TextSize = 12
        ...
        barBack.Position = UDim2.new(0, 22, 1, -24)
        barBack.Size = UDim2.new(1, -44, 0, 6)
        barBack.BackgroundColor3 = Color3.fromRGB(33, 30, 48)
        ...
        local meters = {}
        local meterWrap = Instance.new("Frame")
        meterWrap.Name = "SignalBars"
        meterWrap.AnchorPoint = Vector2.new(1, 0)
        meterWrap.Position = UDim2.new(1, -24, 0, 38)
        meterWrap.Size = UDim2.new(0, 42, 0, 46)
        meterWrap.BackgroundTransparency = 1
        meterWrap.ZIndex = 5
        meterWrap.Parent = card
        for i = 1, 4 do
            local m = Instance.new("Frame")
            m.Name = "Bar" .. i
            m.AnchorPoint = Vector2.new(0, 1)
            m.Position = UDim2.new(0, (i - 1) * 10, 1, 0)
            m.Size = UDim2.new(0, 6, 0, 12 + i * 4)
            m.BackgroundColor3 = (i % 2 == 0) and accent2 or accent
            m.BackgroundTransparency = 0.22
            m.BorderSizePixel = 0
            m.ZIndex = 6
            m.Parent = meterWrap
        ...
        pcall(function()
            local intro = TweenInfo.new(0.58, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
            TweenService:Create(card, intro, {Position = UDim2.new(0.5, 0, 0.5, 0)}):Play()
            TweenService:Create(cardScale, intro, {Scale = 1}):Play()
            TweenService:Create(overlay, TweenInfo.new(0.45), {BackgroundTransparency = 0.18}):Play()
            TweenService:Create(glow, TweenInfo.new(0.85, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageTransparency = 0.25, Size = UDim2.new(0, 560, 0, 280)}):Play()
        end)
        ...
        local function fadeObject(obj, tweenInfo)
            pcall(function()
                ...
                elseif obj:IsA("ImageLabel") then
                    TweenService:Create(obj, tweenInfo, {ImageTransparency = 1, BackgroundTransparency = 1}):Play()
        ...
        env.__ZyxLoadingFinish = function(text)
            ...
            task.spawn(function()
                ...
                while gui.Parent and currentProgress < 0.995 and tick() - finishStart < 1.1 do
                    currentProgress = currentProgress + ((1 - currentProgress) * 0.18)
                    barFill.Size = UDim2.new(currentProgress, 0, 1, 0)
                    percent.Text = tostring(math.floor(currentProgress * 100 + 0.5)) .. "%"
                    task.wait(0.02)
                end
                ...
                local ti = TweenInfo.new(0.48, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
                for _, obj in ipairs(gui:GetDescendants()) do
                    fadeObject(obj, ti)
                end
                pcall(function() TweenService:Create(cardScale, ti, {Scale = 0.97}):Play() end)
                pcall(function() TweenService:Create(glow, ti, {Size = UDim2.new(0, 620, 0, 320)}):Play() end)
                task.wait(0.55)
        ...
        env.__ZyxLoadingError = function(text)
            ...
            if gui and gui.Parent then
                ...
                cardStroke.Color = Color3.fromRGB(255, 80, 90)
                subtitle.Text = "Loader error"
            end
            warn("[ZyxLab FCL Loader]", text)
        end
        ...
        task.spawn(function()
            ...
            while alive and gui.Parent do
                ...
                t = t + dt
                currentProgress = currentProgress + ((targetProgress - currentProgress) * 0.095)
                barFill.Size = UDim2.new(currentProgress, 0, 1, 0)
                percent.Text = tostring(math.floor(currentProgress * 100 + 0.5)) .. "%"

                ringGrad.Rotation = (ringGrad.Rotation + 220 * dt) % 360
                strokeGrad.Rotation = (strokeGrad.Rotation + 75 * dt) % 360
                railGrad.Offset = Vector2.new(math.sin(t * 1.7) * 0.4, 0)
                glow.ImageTransparency = 0.30 + math.sin(t * 2.2) * 0.055
                glow.ImageColor3 = Color3.fromHSV((0.72 + math.sin(t * 0.16) * 0.025) % 1, 0.72, 1)

                for i, m in ipairs(meters) do
                    local pulse = (math.sin(t * 4.2 + i * 0.75) + 1) / 2
                    m.Size = UDim2.new(0, 6, 0, 12 + i * 4 + pulse * 18)
                    m.BackgroundTransparency = 0.16 + (1 - pulse) * 0.45
                end
        ...
        task.delay(30, function()
            if not finished and gui and gui.Parent then
                warn("[ZyxLab FCL Loader] Safety timeout destroying loader")
                alive = false
                gui:Destroy()
                env.__ZyxLoadingDone = true
            end
    ...
    if not ok then
        warn("[ZyxLab FCL Loader] Creation error:", err)
    end
end
...
DEFAULT_THEME = {
    ...
    streamerLevel  = "67",
    streamerIcon   = "none",
    -- Wallhop Viewer customization — Obsidian/FCL dedicated controls
    whlR           = 255,
    whlG           = 255,
    whlB           = 255,
    whlChroma      = false,
    whlThickness   = 20, -- stored as UI scale 1-100, mapped to 0.005-0.1
    ...
    glow_uiGradOn     = false,   -- FCL/Obsidian default: keep glow on edges, not whole UI
...
-- =============================================
-- 🚀 LOAD OBSIDIAN UI + FCL COMPATIBILITY ADAPTER
-- =============================================
pcall(function() ((getgenv and getgenv()) or _G).__ZyxLoadingSet("Loading Obsidian UI", 0.35) end)
...
if not libOk or not Library then
    showErrorOnScreen("Obsidian UI load FAILED: " .. tostring(libErr))
    showErrorOnScreen("Fix: Enable HTTP Requests in your executor settings, then re-run.")
    pcall(function()
        local env = (getgenv and getgenv()) or _G
        if env.__ZyxLoadingError then env.__ZyxLoadingError("Obsidian load failed") end
        task.wait(2)
...
pcall(function() ((getgenv and getgenv()) or _G).__ZyxLoadingSet("Building FCL interface", 0.58) end)

-- Obsidian compatibility layer for the old Xova-style ZyxLab UI calls.
-- FCL keeps the original feature logic/callbacks but renders only the approved tabs.
do
    ...
    function Library:Notification(info)
        if type(info) == "table" then
            return rawNotify(self, {
                Title = tostring(info.Title or "ZyxLab FCL"),
                Description = tostring(info.Description or info.Desc or ""),
                Time = tonumber(info.Time or info.Duration) or 4,
                Icon = info.Icon,
                IconColor = info.IconColor,
            })
        end
        return rawNotify(self, tostring(info), 4)
    end

    local function makeDummyHandle(defaultValue)
        local h = { _value = defaultValue }
        function h:SetValue(v) self._value = v end
        function h:Clear() end
        function h:AddList(_) end
        function h:AddButton(_) return self end
        function h:SetText(v) self._value = v end
        setmetatable(h, {
            ...
            __newindex = function(t, k, v)
                if k == "Value" or k == "Text" then rawset(t, "_value", v) else rawset(t, k, v) end
            end,
        })
        return h
    end

    local function wrapOption(real, defaultValue)
        if not real then return makeDummyHandle(defaultValue) end
        local proxy = {}
        function proxy:Clear()
            if real.SetValues then real:SetValues({}) end
        end
        function proxy:AddList(v)
            if real.AddValues then real:AddValues(v) end
        end
        function proxy:AddButton(info)
            if real.AddButton then return real:AddButton(info) end
            return proxy
        end
        setmetatable(proxy, {
            __index = function(_, k)
                if k == "Value" then return real.Value end
                return real[k]
            end,
            __newindex = function(_, k, v)
                if k == "Value" then
                    if real.SetValue then real:SetValue(v) else real.Value = v end
                elseif k == "Text" then
                    if real.SetText then real:SetText(v) elseif real.TextLabel then real.TextLabel.Text = tostring(v) end
                else
                    rawset(proxy, k, v)
                end
            end,
    ...
    local function sanitizeIndex(text)
        text = tostring(text or "Item"):gsub("[^%w_]", "_")
        if text == "" then text = "Item" end
        return text
    end

    local FCL_TITLE_ROUTES = {
        ["Ragdoll Timer"] = { tab = "Visuals", section = "Helpers" },
        ["Loud Footsteps"] = { tab = "Audio", section = "Effects" },
    }

    local FCL_ALLOWED_BY_PAGE = {
        Visuals = "all",
        Audio = "all",
        Customize = "all_except_streamer",
        Configs = "all",
        Info = "all",
        Performance = "all",
        Spectate = "all",
        Movements = {
            ["WallHop"] = true,
            ["WallHop Jump Delay"] = true,
            ["WallHop Flick Speed"] = true,
        },
        Misc = {
            ["Anti-Error"] = true,
            ["Beast Notifier"] = true,
            ["Beast Prediction"] = true,
            ["Anti AFK"] = true,
            ["Auto Interact"] = true,
            ["PC Fast Hack"] = true,
            ["Fix Camera"] = true,
            ["Fast Mobile Crawl"] = true,
            ["PC Crawl"] = true,
        },
        Search = "search_notice",
    }
    ...
    local function createCompatPage(ctx, pageTitle)
        local tabName = PAGE_TO_TAB[pageTitle]
        local page = {
            Title = pageTitle,
            TabName = tabName,
            CurrentSection = "Main",
        ...
        function page:_allowed(info, method)
            if not self.TabName then return nil end
            local title = type(info) == "table" and (info.Title or info.Text or info.Name) or tostring(info or "")
            if method == "Section" then return { tab = self.TabName, section = title } end

            local moved = FCL_TITLE_ROUTES[title]
            if moved then return moved end

            local mode = FCL_ALLOWED_BY_PAGE[self.Title]
            if mode == "all" then return { tab = self.TabName, section = self.CurrentSection } end
            if mode == "all_except_streamer" then
                if tostring(title):lower():find("streamer", 1, true) then return nil end
                return { tab = self.TabName, section = self.CurrentSection }
            end
            if type(mode) == "table" and mode[title] then
                return { tab = self.TabName, section = self.CurrentSection }
            end
            return nil
        end

        function page:_getGroup(tabName, sectionName)
            sectionName = sectionName or "Main"
            local key = tostring(tabName) .. "::" .. tostring(sectionName)
            if self._ctx.Groups[key] then return self._ctx.Groups[key] end
            local tab = self._ctx.Tabs[tabName]
            if not tab then return nil end
            self._ctx.GroupSide = (self._ctx.GroupSide or 0) + 1
            local icon = nil
            if sectionName == "Detection" then icon = "scan-eye"
            elseif sectionName == "Helpers" then icon = "sparkles"
            elseif sectionName == "WallHop" or sectionName == "Wallhop Viewer" or sectionName == "Wallhop Viewer Customization" then icon = "footprints"
            elseif sectionName == "Master" or sectionName == "Per-Sound Overrides" or sectionName == "Effects" then icon = "volume-2"
            elseif sectionName:lower():find("glow", 1, true) then icon = "sparkles"
            elseif sectionName:lower():find("config", 1, true) or sectionName:lower():find("slot", 1, true) then icon = "save"
            elseif sectionName:lower():find("profile", 1, true) then icon = "user"
            elseif sectionName:lower():find("fps", 1, true) or sectionName:lower():find("performance", 1, true) then icon = "gauge"
            end
            local gb
            if tabName == "Info" then
                gb = tab:AddLeftGroupbox(sectionName, icon)
            elseif self._ctx.GroupSide % 2 == 1 then
                gb = tab:AddLeftGroupbox(sectionName, icon)
            else
                gb = tab:AddRightGroupbox(sectionName, icon)
            end
            self._ctx.Groups[key] = gb
            return gb
        end

        function page:Section(name)
            -- Obsidian creates visible groupboxes immediately.  The old Xova UI
            -- could create empty sections without much visual noise, but in
            -- FCL those showed up as blank boxes after feature filtering.
            -- Only remember the current section here; the first allowed control
            -- in that section will create the groupbox lazily.
            self.CurrentSection = tostring(name or "Main")
        end

        function page:Toggle(info)
            local route = self:_allowed(info, "Toggle")
            if not route then return makeDummyHandle(info and info.Value) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(info and info.Value) end
            self._counter += 1
            local idx = "FCL_Toggle_" .. sanitizeIndex(info.Title) .. "_" .. tostring(self._counter)
            local obj = gb:AddToggle(idx, {
                Text = info.Title or "Toggle",
                Tooltip = info.Desc,
                Default = info.Value == true,
                Callback = info.Callback,
            })
            return wrapOption(obj, info.Value)
        end

        function page:Button(info)
            local route = self:_allowed(info, "Button")
            if not route then return makeDummyHandle(false) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(false) end
            local btn = gb:AddButton({
                Text = info.Title or info.Text or "Button",
                Tooltip = info.Desc,
                Func = info.Callback or function() end,
                DoubleClick = info.DoubleClick == true,
            })
            return btn or makeDummyHandle(false)
        end

        function page:Slider(info)
            local route = self:_allowed(info, "Slider")
            if not route then return makeDummyHandle(info and info.Value) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(info and info.Value) end
            self._counter += 1
            local idx = "FCL_Slider_" .. sanitizeIndex(info.Title) .. "_" .. tostring(self._counter)
            local obj = gb:AddSlider(idx, {
                Text = info.Title or "Slider",
                Tooltip = info.Desc,
                Default = tonumber(info.Value) or tonumber(info.Min) or 0,
        ...
        function page:Input(info)
            local route = self:_allowed(info, "Input")
            if not route then return makeDummyHandle(info and info.Value) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(info and info.Value) end
            self._counter += 1
            local idx = "FCL_Input_" .. sanitizeIndex(info.Title) .. "_" .. tostring(self._counter)
            local obj = gb:AddInput(idx, {
                Text = info.Title or "Input",
                Tooltip = info.Desc,
                Default = tostring(info.Value or ""),
        ...
        function page:Dropdown(info)
            local route = self:_allowed(info, "Dropdown")
            if not route then return makeDummyHandle(info and info.Value) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(info and info.Value) end
            self._counter += 1
            local idx = "FCL_Dropdown_" .. sanitizeIndex(info.Title) .. "_" .. tostring(self._counter)
            local values = info.List or info.Values or {}
            local obj = gb:AddDropdown(idx, {
                Text = info.Title or "Dropdown",
                Tooltip = info.Desc,
                Values = values,
                Default = info.Value or info.Default or values[1],
        ...
        function page:Paragraph(info)
            local route = self:_allowed(info, "Paragraph")
            if not route then return makeDummyHandle(false) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(false) end
            local text = tostring(info.Title or "")
            local desc = tostring(info.Desc or "")
            if desc ~= "" then text = text .. "\n" .. desc end
            local obj = gb:AddLabel(text, true)
            return wrapOption(obj, text)
        end

        function page:RightLabel(args)
            local route = self:_allowed(args, "RightLabel")
            if not route then return makeDummyHandle(args and args.Right) end
            local gb = self:_getGroup(route.tab, route.section)
            if not gb then return makeDummyHandle(args and args.Right) end
            local title = tostring(args.Title or "Info")
            local label = gb:AddLabel(title .. ": " .. tostring(args.Right or ""), false)
            local proxy = {}
            setmetatable(proxy, {
                __newindex = function(_, k, v)
                    if k == "Text" then
                        if label.SetText then label:SetText(title .. ": " .. tostring(v)) end
                    else rawset(proxy, k, v) end
                end,
                __index = function(_, k)
                    if k == "Text" then return label.Text end
                    return label[k]
                end,
            })
            return proxy
    ...
    function Library:Window(info)
        local win = self:CreateWindow({
            Title = "ZyxLab FCL Edition",
            Footer = "FCL Edition • Obsidian UI",
            Icon = info and (info.Icon or info.BbIcon or info.PillIcon) or "cpu",
            NotifySide = "Right",
            GlobalSearch = true,
            AutoShow = true,
            Center = true,
        ...
        local ctx = { Window = win, Tabs = {}, Groups = {}, GroupSide = 0 }
        -- Obsidian already has global search in the title bar, so FCL does not
        -- need a separate Search tab with no real feature controls.
        local order = { "Visuals", "Movement", "Audio", "Customize", "FPS", "Misc", "Spectate", "Configs", "Info" }
        for _, name in ipairs(order) do
            ctx.Tabs[name] = win:AddTab(name, TAB_ICONS[name] or "circle")
        end

        -- FCL tweak: the Info content is a dashboard card, not a left/right
        -- settings column.  Center its only column in the middle of Obsidian.
        local function centerInfoTab(tab)
            if not tab or not tab.Sides then return end
            local left, right = tab.Sides[1], tab.Sides[2]
            local originalRefresh = tab.RefreshSides
            function tab:RefreshSides(...)
                if originalRefresh then pcall(originalRefresh, self, ...) end
                local yOffset = 0
                if left and left.Position then yOffset = left.Position.Y.Offset end
                if right then
                    right.Visible = false
                    right.Size = UDim2.new(0, 0, 1, -yOffset)
                end
                if left then
                    left.Visible = true
                    left.AnchorPoint = Vector2.new(0.5, 0)
                    left.Position = UDim2.new(0.5, 0, 0, yOffset)
                    left.Size = UDim2.new(0.72, 0, 1, -yOffset)
                end
            end
            tab:RefreshSides()
        end
        centerInfoTab(ctx.Tabs.Info)

        local compat = { _ctx = ctx, _pages = {} }
        function compat:NewPage(pageInfo)
            local title = tostring(pageInfo and pageInfo.Title or "Page")
            local page = createCompatPage(ctx, title)
...
local function fireStartupNotification()
    ...
    pcall(function()
        Library:Notification({
            Title = "ZyxLab FCL",
            Desc = "FCL Edition loaded • Obsidian UI",
            Duration = 4,
            Type = "Success",
        })
    end)
...
local function pushAccentToLibrary(force)
    ...
    -- Obsidian has a real theme registry.  Update ONLY AccentColor, then let
    -- the library repaint objects that were explicitly registered as accents
    -- (tab icons, active toggles, slider fills, selected text, etc.).
    -- This fixes the old Xova-style near-color scanner that could recolor the
    -- whole dark UI when the user picked black or another background-like color.
    pcall(function()
    ...
    -- Custom ZyxLab overlay pieces do not live in Obsidian's registry.  Only
    -- repaint objects that were deliberately tagged by our script.  No color
    -- matching, no background guessing.
...
pcall(function() ((getgenv and getgenv()) or _G).__ZyxLoadingSet("Building FCL tabs", 0.70) end)
...
do
    local function whlScaleToThickness(v)
        v = math.clamp(tonumber(v) or 20, 1, 100)
        return 0.005 + (v - 1) / 99 * (0.1 - 0.005)
    end

    local function whlThicknessToScale(t)
        t = math.clamp(tonumber(t) or 0.02, 0.005, 0.1)
        return math.floor(((t - 0.005) / (0.1 - 0.005)) * 99 + 1 + 0.5)
    end

    local whl_enabled   = false
    local whl_color     = Color3.fromRGB(theme.whlR or 255, theme.whlG or 255, theme.whlB or 255)
    local whl_thickness = whlScaleToThickness(theme.whlThickness or 20)
    local whl_loop      = nil
    local whl_chroma    = theme.whlChroma == true
    ...
    local function whl_applyTheme()
        whl_color = Color3.fromRGB(theme.whlR or 255, theme.whlG or 255, theme.whlB or 255)
        whl_thickness = whlScaleToThickness(theme.whlThickness or 20)
        whl_chroma = theme.whlChroma == true
        if whl_enabled then whl_apply() end
    end
    ...
    _G.__ZyxWhl = {
        setColor = function(c)
            whl_color = c
            theme.whlR = math.floor(c.R * 255 + 0.5)
            theme.whlG = math.floor(c.G * 255 + 0.5)
            theme.whlB = math.floor(c.B * 255 + 0.5)
            if whl_enabled then whl_apply() end
        end,
        setRuntimeColor = function(c)
            whl_color = c
            if whl_enabled then whl_apply() end
        end,
        setThickness = function(t)
            whl_thickness = math.clamp(tonumber(t) or whl_thickness, 0.005, 0.1)
            theme.whlThickness = whlThicknessToScale(whl_thickness)
            if whl_enabled then whl_apply() end
        end,
        setThicknessScale = function(v)
            theme.whlThickness = math.clamp(tonumber(v) or 20, 1, 100)
            whl_thickness = whlScaleToThickness(theme.whlThickness)
            if whl_enabled then whl_apply() end
        end,
        setChroma = function(b)
            whl_chroma = b == true
            theme.whlChroma = whl_chroma
            if not whl_chroma then
                whl_color = Color3.fromRGB(theme.whlR or 255, theme.whlG or 255, theme.whlB or 255)
            end
            if whl_enabled then whl_apply() end
        end,
        ...
        getThicknessScale = function()
            return whlThicknessToScale(whl_thickness)
        end,
        applyTheme = whl_applyTheme,
    }
...
do
    ...
    GM = {
        S = {
            ...
            uiGradOn=false, uiGradSpeed=0.10,
        ...
        _uiGrad=nil,_uiGrads=nil,_orbit=nil,_orbit2=nil,_comet=nil,
        _textLabels={},
    ...
    function GM:Init(bg)
        self._bg=bg
        pcall(function() bg.ClipsDescendants = false end)
        if self._backCons then
            for _,c in ipairs(self._backCons) do pcall(function() c:Disconnect() end) end
        end
        self._backCons = {}
        local bgParent = bg.Parent
        if bgParent then
            for _,v in pairs(bgParent:GetChildren()) do
                if v.Name == "ZyxFCLGlowBackplate" then v:Destroy() end
            end
        end
        for _,v in pairs(bg:GetChildren()) do
            if v.Name:sub(1,4)=="Xova" or v.Name:sub(1,6)=="ZyxFCL" or v.Name=="Shadow" then v:Destroy() end
        end

        -- Backplate lives as a sibling behind Obsidian's Main frame.  The glow
        -- attaches here so it blooms behind the UI instead of covering controls.
        local glowRoot=Instance.new("Frame")
        glowRoot.Name="ZyxFCLGlowBackplate"
        glowRoot.BackgroundTransparency=1
        glowRoot.BorderSizePixel=0
        glowRoot.ClipsDescendants=false
        glowRoot.Parent=bgParent or bg
        local function syncBackplate()
            if not glowRoot or not glowRoot.Parent or not bg or not bg.Parent then return end
            glowRoot.AnchorPoint=bg.AnchorPoint
            glowRoot.Position=bg.Position
            glowRoot.Size=bg.Size
            glowRoot.Rotation=bg.Rotation
            glowRoot.Visible=bg.Visible
            glowRoot.ZIndex=math.max((bg.ZIndex or 1)-1,0)
            if self._glow then self._glow.ZIndex=glowRoot.ZIndex end
            if self._orbit then self._orbit.ZIndex=glowRoot.ZIndex end
            if self._orbit2 then self._orbit2.ZIndex=glowRoot.ZIndex end
            if self._comet then self._comet.ZIndex=glowRoot.ZIndex end
        end
        syncBackplate()
        for _,prop in ipairs({"AnchorPoint","Position","Size","Rotation","Visible","ZIndex"}) do
            pcall(function()
                table.insert(self._backCons, bg:GetPropertyChangedSignal(prop):Connect(syncBackplate))
            end)
        end
        self._glowRoot=glowRoot
        self._syncBackplate=syncBackplate

        -- UI Background gradients
        -- Obsidian is built from several opaque top-level surfaces: Main, the
        -- left tab rail, the central Container, and the footer strip.  A single
        -- UIGradient on Main only shows through the transparent title/top bar,
        -- so FCL mirrors the same animated background gradient onto each major
        -- background surface.  Controls/groupboxes keep their own backgrounds.
        self._uiGrads={}
        local function addUIGradSurface(surface)
            if not surface or not surface:IsA("GuiObject") then return end
            for _,child in ipairs(surface:GetChildren()) do
                if child:IsA("UIGradient") and child.Name=="XovaUIGrad" then
                    child:Destroy()
                end
            end
            ...
            g.Enabled=self.S.uiGradOn
            table.insert(self._uiGrads,g)
            return g
        end
        addUIGradSurface(bg)
        for _,child in ipairs(bg:GetChildren()) do
            if child:IsA("GuiObject") then
                local isContainer = child.Name == "Container"
                local isTabRail = child:IsA("ScrollingFrame") and child.Size.Y.Scale > 0.45
                local isFooter = child:IsA("Frame") and child.AnchorPoint.Y == 1 and child.Size.X.Scale == 1 and child.Size.Y.Offset >= 18
                if isContainer or isTabRail or isFooter then
                    addUIGradSurface(child)
                end
            end
        end
        self._uiGrad=self._uiGrads[1]
        -- Animated border
        ...
        -- Outer glow, behind the window on the backplate.
        local img=Instance.new("ImageLabel"); img.Name="XovaGlow"; img.Parent=glowRoot
        ...
        img.ZIndex=glowRoot.ZIndex; img.Image="rbxassetid://8992230677"
        ...
        -- Orbit primary
        local o1=Instance.new("ImageLabel"); o1.Name="XovaOrbit"; o1.Parent=glowRoot
        o1.AnchorPoint=Vector2.new(0.5,0.5); o1.BackgroundTransparency=1; o1.BorderSizePixel=0
        o1.Position=UDim2.new(0.5,0,0,0); o1.Size=UDim2.new(0,130,0,130); o1.ZIndex=glowRoot.ZIndex
        ...
        -- Orbit secondary
        local o2=Instance.new("ImageLabel"); o2.Name="XovaOrbit2"; o2.Parent=glowRoot
        o2.AnchorPoint=Vector2.new(0.5,0.5); o2.BackgroundTransparency=1; o2.BorderSizePixel=0
        o2.Position=UDim2.new(0.5,0,0,0); o2.Size=UDim2.new(0,100,0,100); o2.ZIndex=glowRoot.ZIndex
        ...
        -- Comet
        local cm=Instance.new("Frame"); cm.Name="XovaComet"; cm.Parent=glowRoot
        ...
        cm.ZIndex=glowRoot.ZIndex; cm.Visible=false
    ...
    function GM:_eachUIGrad(fn)
        if self._uiGrads then
            for _,g in ipairs(self._uiGrads) do
                if g and g.Parent then
                    pcall(fn,g)
                end
            end
        elseif self._uiGrad and self._uiGrad.Parent then
            pcall(fn,self._uiGrad)
        end
    end

    function GM:SetUIGradientEnabled(v)
        self:_eachUIGrad(function(g)
            g.Enabled = v == true
        end)
    end

    function GM:SetUIGradient(cs, rot)
        self:_eachUIGrad(function(g)
            if cs then g.Color = cs end
            if rot then g.Rotation = rot end
            g.Enabled = self.S.enabled and self.S.uiGradOn
        end)
    end
    ...
    function GM:_startLoop()
        ...
        self._conn=RunService.Heartbeat:Connect(function(dt)
            ...
            if self._syncBackplate then pcall(self._syncBackplate) end
            ...
            if S.mode=="Rainbow" then
                ...
                if S.uiGradOn then self:SetUIGradient(cs,(t*36)%360) end
            elseif S.mode=="Wave" then
                local off=(t*S.uiGradSpeed*2.5)%1
                if S.uiGradOn then self:SetUIGradient(self:SCS(off),math.sin(t*1.4)*90) end
                ...
                if S.uiGradOn then
                    local off3=(t*S.uiGradSpeed)%1; self:SetUIGradient(self:SCS(off3),(t*18)%360)
                end
            end
    ...
    function GM:_startTextLoop()
        ...
        task.delay(0.6,function()
            local parent=getGuiParent()
            local gui=parent:WaitForChild("Obsidian",6)
    ...
    function GM:SetEnabled(v)
        ...
        self:SetUIGradientEnabled(v and self.S.uiGradOn)
    end
    ...
    function GM:SetMode(m)
        ...
        if m=="Wave" then self:SetUIGradientEnabled(self.S.enabled and self.S.uiGradOn) end
    end
    ...
    function GM:FxGlitch()
        ...
        for _=1,12 do
            ...
            self:SetUIGradient(nil,math.random(0,360))
        end
    ...
    local function FindGlowBG()
        -- Obsidian's actual window frame is ScreenGui "Obsidian" -> TextButton
        -- "Main".  GlowManager now attaches glow effects to a sibling
        -- backplate behind Main, while border/text effects stay on Main.
        local function findIn(root)
            if not root then return nil end
            local gui = root:FindFirstChild("Obsidian", true)
            if not gui then return nil end
            local main = gui:FindFirstChild("Main", true)
            if main and main:IsA("GuiObject") then return main end
            return nil
        end

        if collectGuiRoots then
            for _, root in ipairs(collectGuiRoots()) do
                local found = findIn(root)
                if found then return found end
            end
        end

        return findIn(getGuiParent())
    end
...
do
    ...
    local function applyGlowLive()
        ...
        pcall(function()
            ...
            -- UI gradient across all major Obsidian background surfaces
            if GM.SetUIGradientEnabled then GM:SetUIGradientEnabled(GM.S.enabled and GM.S.uiGradOn) end
            -- Mode
    ...
    glowHandles.uiGradOn = customizePage:Toggle({
        Title="Animated Background",Desc="Live sweeping gradient across the main background, tab rail, and content body",
        Value = theme.glow_uiGradOn ~= false,
        Callback=function(v)
            theme.glow_uiGradOn = v
            GM.S.uiGradOn=v
            if GM.SetUIGradientEnabled then GM:SetUIGradientEnabled(GM.S.enabled and v) end
        end,
    })
...
customizePage:Section("Wallhop Viewer Customization")

customizePage:Button({
    Title = "Wallhop Viewer Line Color",
    Desc  = "Pick the SelectionBox outline color used by Wallhop Viewer",
    Text  = "🎨 Pick",
    Callback = function()
        local currentColor = Color3.fromRGB(theme.whlR or 255, theme.whlG or 255, theme.whlB or 255)
        if _G.__ZyxWhl and _G.__ZyxWhl.getColor then
            pcall(function() currentColor = _G.__ZyxWhl.getColor() end)
        end
        openPicker({
            title    = "Wallhop Viewer — Line Color",
            color    = currentColor,
            chroma   = _G.__ZyxWhl and _G.__ZyxWhl.getChroma() or theme.whlChroma == true,
            onChange = function(c)
...
customizePage:Toggle({
    Title = "Wallhop Viewer Chroma",
    Desc  = "Rainbow-cycle only the Wallhop Viewer outlines",
    Value = theme.whlChroma == true,
    Callback = function(v)
        theme.whlChroma = v == true
        if _G.__ZyxWhl then _G.__ZyxWhl.setChroma(v) end
    end,
})

customizePage:Slider({
    Title    = "Wallhop Viewer Line Thickness",
    Desc     = "SelectionBox line thickness (0.005 – 0.1)",
    Min      = 1,
    Max      = 100,
    Rounding = 0,
    Value    = theme.whlThickness or 20,
    Callback = function(v)
        theme.whlThickness = math.clamp(tonumber(v) or 20, 1, 100)
        if _G.__ZyxWhl then _G.__ZyxWhl.setThicknessScale(theme.whlThickness) end
    end,
})

customizePage:Button({
    Title = "Reset Wallhop Viewer Style",
    Desc  = "Reset Wallhop Viewer color, chroma, and line thickness only",
    Text  = "↺ Reset",
    Callback = function()
        theme.whlR, theme.whlG, theme.whlB = 255, 255, 255
        theme.whlChroma = false
        theme.whlThickness = 20
        if _G.__ZyxWhl then _G.__ZyxWhl.applyTheme() end
        Library:Notification({
            Title = "Wallhop Viewer",
            Desc = "Customization reset.",
            Duration = 3,
            Type = "Success",
        })
    end,
...
local function applyLoadedConfig(name)
    ...
    refreshSoundpack()
    refreshAllESPs()
    if _G.__ZyxWhl and _G.__ZyxWhl.applyTheme then pcall(_G.__ZyxWhl.applyTheme) end
...
local function setupFeatureSearch(pageRegistry)
    ...
    local items = {
        ...
        {page = "Customize", feature = "Wallhop Viewer Line Color"},
        {page = "Customize", feature = "Wallhop Viewer Chroma"},
        {page = "Customize", feature = "Wallhop Viewer Line Thickness"},
        {page = "Customize", feature = "Reset Wallhop Viewer Style"},
...
-- FCL: Obsidian GlobalSearch replaces the old Xova-specific search page.
-- setupFeatureSearch disabled intentionally.
...
do
    ...
    RunService.Heartbeat:Connect(function(dt)
        ...
        if espAccum >= 0.20 then
            ...
            -- Wallhop viewer chroma: runtime-only color so saved static color is preserved.
            if _G.__ZyxWhl and _G.__ZyxWhl.getChroma() then
                if _G.__ZyxWhl.setRuntimeColor then
                    _G.__ZyxWhl.setRuntimeColor(Color3.fromHSV(chromaHue, 1, 1))
                else
...
print("[ZyxLab FCL Edition] Loaded — Obsidian UI · Made by ZyxFTF")
